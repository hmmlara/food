...
<main class="content">
				<div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <a href="add_payment.php" class="btn btn-dark">Add New Payment</a>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        $count=1;
                                            foreach($payments as $payment)
                                            {
                                                ...
                                                echo "<td id='".$payment['id']."'><a class='btn btn-success mx-3' href='edit_payment.php?id=".$payment['id']."'>Edit </a> <button class='btn btn-danger mx-3 p_delete'>Delete </button> </td>";
                                                echo "</tr>";
                                            }
                                        ?>
                                    </tbody>
