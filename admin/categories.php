                                    ...
                                    <tbody>
                                        ...
                                        $count=1;
                                            foreach($categories as $category)
                                            {
                                                ...
                                                echo "<td id='".$category['id']."'><a class='btn btn-warning mx-3' href='edit_category.php?id=".$category['id']."'>Edit </a> <button class='btn btn-danger mx-3 btn2_delete'>Delete </button> </td>";
                                                echo "</tr>";
                                            }
                                        ?>
                                    </tbody>
