...
<body>
	<div class="wrapper">
        ...
        <?php $curr_url =  $_SERVER['PHP_SELF']; ?>
				<ul class="sidebar-nav">
					<li class="sidebar-header">
						Pages
					</li>

					<li class="sidebar-item <?php echo basename($curr_url) == 'index.php' ? 'active' : ''; ?>">
						<a class="sidebar-link" href="index.php">
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
            </a>
					</li>

					<li class="sidebar-item <?php echo basename($curr_url) == 'categories.php' ? 'active' : ''; ?>">
